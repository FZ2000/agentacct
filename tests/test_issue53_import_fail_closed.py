...
def test_unresolvable_excluded_file_does_not_withhold_clean_sessions(tmp_path):
    ...
    # therefore only asserted when the scan actually was truncated: pinning it
    # unconditionally turned a tuned constant into a test failure when the budget
    # moved from 256 to 512 lines.
